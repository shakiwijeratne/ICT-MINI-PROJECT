  ...
  return (
    <div className="page">
      <PageHeader
        ...
        subtitle="Track your hours, skills, and overall completion"
      />
          ...
          <div style={{ width: '100%', height: 280, marginTop: '1rem' }}>
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={weeklyHours}>
                ...
                <XAxis dataKey="week" stroke="#aab6d1" />
                <YAxis stroke="#aab6d1" />
                <Tooltip
                  contentStyle={{
                    backgroundColor: '#111a2d',
                    borderColor: 'rgba(145, 164, 218, 0.16)',
                    borderRadius: '8px',
                    color: '#fff',
                  }}
                />
        ...
        <Card>
          ...
          <div style={{ width: '100%', height: 280, marginTop: '1rem' }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={
                  defaultSkills.filter((s) => s.score > 0).length
                    ? defaultSkills.filter((s) => s.score > 0)
              ...
              >
                ...
                <XAxis
                  ...
                  stroke="#aab6d1"
                />
                <YAxis domain={[0, 5]} stroke="#aab6d1" />
                <Tooltip
                  contentStyle={{
                    backgroundColor: '#111a2d',
                    borderColor: 'rgba(145, 164, 218, 0.16)',
                ...
                />
                <Bar dataKey="score" fill="#7b3cf1" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
