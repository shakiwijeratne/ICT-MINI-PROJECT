  ...
  return (
    <div className="page">
      ...
      <div className="stats-grid">
        ...
        <StatCard label="Evaluations Completed" value={evaluations.length} icon={<CheckCircle size={24}/>}/>
      ...
      <div className="grid-2">
        ...
        <Card>
        <h3>Diary Review Status</h3>
        <EmptyState message="Diary approval actions are available in the diary review page." />
        </Card>
      </div>
    </div>
  );
